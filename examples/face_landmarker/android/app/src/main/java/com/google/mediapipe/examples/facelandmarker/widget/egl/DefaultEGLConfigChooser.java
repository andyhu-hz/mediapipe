...
/**
 * @FileName: DefaultEGLConfigChooser
 * @Description:
 * @Author: Gene
...
public class DefaultEGLConfigChooser implements GLTextureView.EGLConfigChooser {
    ...
    @Override
    public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display, GLTextureView.GLESVersion version) {
    ...
    private int[] getConfigSpec(GLTextureView.GLESVersion version) {
        ...
        if (version == GLTextureView.GLESVersion.OpenGLES20) {
            // set ES 2.0
